...
\begin{itemize}
  ...
  \item An \textit{inverted-F} design, which has a small form factorer and a nearly full 3D omni-directional radiation pattern.
  \item A \textit{ring antenna}, which has a uni-directional, and an even smaller form factor than the inverted-F antenna \cite{paper-lowProfileRingAntenna}.
  \item A \textit{helical patch} antenna, which is simply a "zig-zag" helical shape flattened onto a PCB.
