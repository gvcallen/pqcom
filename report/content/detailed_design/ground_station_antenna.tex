...
As discussed, the antenna should be capable of receiving from both the 405 MHz radiosonde protocol, as well as the custom LoRa-based protocol in the amateur radio band of 430 to 440 MHz. A helical antenna is suggested, for the following reasons:
\begin{itemize}
