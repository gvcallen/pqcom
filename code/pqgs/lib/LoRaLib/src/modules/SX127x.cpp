...
void SX127x::setDio0Action(void (*func)(void), bool pcInt) {
  #ifndef ESP32
  if (!pcInt)
    attachInterrupt(digitalPinToInterrupt(_mod->getInt0()), func, RISING);
  else
    attachPCINT(digitalPinToPCINT(_mod->getInt0()), func, RISING);
...
void SX127x::setDio1Action(void (*func)(void), bool pcInt) {
  #ifndef ESP32
  if (!pcInt)
    attachInterrupt(digitalPinToInterrupt(_mod->getInt1()), func, RISING);
  else
    attachPCINT(digitalPinToPCINT(_mod->getInt1()), func, RISING);
